            ...
            <aside class="aside" aria-label="Panel lateral">
                <section class="panel panel--subscribe newsletter-panel" data-newsletter-panel aria-label="Recibe novedades">
                    <div class="panel__title-row newsletter-panel__header">
                        ...
                        <button type="button" class="newsletter-panel__trigger" data-newsletter-toggle aria-expanded="false" aria-controls="newsletter-form-shell-category">
                            Suscribete
                        </button>
                    </div>
                    <p class="panel__tip" id="newsletter-tip-category" hidden>Te enviaremos un correo cuando publiquemos contenido relevante para ti. Sin spam.</p>
                    <div class="newsletter-panel__form-shell" id="newsletter-form-shell-category" data-newsletter-form hidden>
                        <?php
