(function () {
	...
	function setMonthlyPrice(element, value) {
		...
		amount.className = "home-hero__vehicle-price-amount";
		const valueText = document.createElement("span");
		valueText.textContent = String(value).replace(/\s*€/g, "").trim();
		const currency = document.createElement("span");
		currency.textContent = "€";
		amount.append(valueText, currency);

		const suffix = document.createElement("span");
		suffix.className = "home-hero__vehicle-price-period";
	...
	function renderLogo(car) {
		...
		logoBox.classList.add(
			"home-hero__vehicle-logo--" + (car.logoShape || "default"),
		);
